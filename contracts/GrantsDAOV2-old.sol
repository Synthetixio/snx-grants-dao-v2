...
// /// Support for SIP/SCCP payments
// /// Intiatives (by gdao) and grants (by applicants) categories split
// /// Explore gnosis safe snap for voting
...
//     enum ProposalState {ACCEPTED, COMPLETED, REJECTED}

//     ///@notice A proposal struct, containing all the required fields for a proposal
//     struct Proposal {
//         string title;
//         // string description;
//         string url; //ipfs hash of the proposal, or github link
